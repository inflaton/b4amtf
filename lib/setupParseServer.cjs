async function setupParseServer(app, nodeEnv) {
  ...
  const config = {
    ...
    appId:
      ...
      "NRXUJ7VoDl3pho3QihRUnN6JoRdAOPiLnV5A0vifIwE",
    masterKey:
      process.env.PARSE_MASTER_KEY ||
      "wVuwX7XYH0E2X9fmMXoxyigZI3eEzJDnAGG3B8AI4lA",
    javascriptKey:
      process.env.VUE_APP_PARSE_JS_KEY ||
      "1EmGj7cdldzyzoYEWTiaeoWwMt5q7dOXWsK4r1Q03ic",
    ...
    publicServerURL:
      process.env.PUBLIC_SERVER_URL || "http://localhost:8080/parse",
  ...
  const PARSE_DASHBOARD = process.env.PARSE_DASHBOARD;
  if (PARSE_DASHBOARD) {
